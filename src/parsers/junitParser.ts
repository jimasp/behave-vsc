...
export function getProjQueueJunitFileMap(ps: ProjectSettings, run: vscode.TestRun, runId: string, projQueueItems: QueueItem[]) {
  const projJunitRunDirUri = getJunitProjRunDirUri(run, runId, ps.name);
