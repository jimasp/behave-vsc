...
export const getExpectedResults = (projUri: vscode.Uri, config: Configuration): TestResult[] => {
  ...
  const expectedResults: TestResult[] = [
    new TestResult({
      scenario_featureFileRelativePath: 'features_folder/basic_no_skip.feature',
      ...
      test_id: '.../sibling steps folder 1/features_folder/basic_no_skip.feature/run a successful test',
      test_label: 'run a successful test',
      test_parent: '.../sibling steps folder 1/features_folder/basic_no_skip.feature',
      test_uri: '.../sibling steps folder 1/features_folder/basic_no_skip.feature'
    }),
    ...
    new TestResult({
      ...
      test_description: undefined,
      test_error: undefined,
      test_id: '.../sibling steps folder 1/features_folder/basic_no_skip.feature/run a failing test',
    ...
    new TestResult({
      ...
      scenario_featureFileRelativePath: 'features_folder/outline_mixed_no_skip.feature',
      ...
      test_description: undefined,
      test_error: undefined,
      test_id: '.../sibling steps folder 1/features_folder/outline_mixed_no_skip.feature/Blenders Success <thing>',
      test_label: 'Blenders Success <thing>',
      test_parent: '.../sibling steps folder 1/features_folder/outline_mixed_no_skip.feature',
      test_uri: '.../sibling steps folder 1/features_folder/outline_mixed_no_skip.feature'
    }),
    ...
    new TestResult({
      ...
      test_description: undefined,
      test_error: undefined,
      test_id: '.../sibling steps folder 1/features_folder/outline_mixed_no_skip.feature/Blenders Fail <thing>',
    ...
    new TestResult({
      ...
      test_description: undefined,
      test_error: undefined,
      test_id: '.../sibling steps folder 1/features_folder/outline_mixed_no_skip.feature/Blenders Success paramless',
    ...
    new TestResult({
      ...
      test_description: undefined,
      test_error: undefined,
      test_id: '.../sibling steps folder 1/features_folder/outline_mixed_no_skip.feature/Blenders Fail paramless',
    ...
    new TestResult({
      ...
      scenario_featureFileRelativePath: 'features_folder/table.feature',
      ...
      test_description: undefined,
      test_error: undefined,
      test_id: '.../sibling steps folder 1/features_folder/table.feature/Use a table (success)',
      test_label: 'Use a table (success)',
      test_parent: '.../sibling steps folder 1/features_folder/table.feature',
      test_uri: '.../sibling steps folder 1/features_folder/table.feature'
    }),
    ...
    new TestResult({
      ...
      test_description: undefined,
      test_error: undefined,
      test_id: '.../sibling steps folder 1/features_folder/table.feature/Use a table (fail)',
