...
export async function run(): Promise<void[]> {
	...
	const sSuite = runner("../**/simple suite/**.test.js", ["../**/simple suite/**.runDebug.test.js", "../**/simple suite/**.runScenarios.test.js"]);
	const aSuite = runner("../**/project A suite/**.test.js");
	const bSuite = runner("../**/project B suite/**.test.js", ["../**/project B suite/**.runDebug.test.js"]);
	const rpSuite = runner("../**/run profiles suite/**.test.js", ["../**/run profiles suite/**.runDebug.test.js"]);
	...
	const wdSuite = runner("../**/working dir suite/**.test.js", ["../**/working dir suite/**.runDebug.test.js"]);
