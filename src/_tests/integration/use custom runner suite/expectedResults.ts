...
import { TestResult } from "../_common/types.js"

export function getExpectedCounts(): ProjParseCounts {
  const testCount = getExpectedResultsForBehaveDjangoProfileWaitForJUnitFiles().length;
  return {
    tests: { nodeCount: 9, testCount: testCount },
    featureFilesExceptEmptyOrCommentedOut: 3, stepFilesExceptEmptyOrCommentedOut: 1,
    stepFileStepsExceptCommentedOut: 5, featureFileStepsExceptCommentedOut: 14, stepMappings: 14
  };
}
...
export const getExpectedResultsForNoProfile = (): TestResult[] => {
  ...
  const expectedResults: TestResult[] = [
    ...
    new TestResult({
      scenario_featureFileRelativePath: 'django/mysite/features/myscript.feature',
      scenario_featureName: 'MyScript',
      scenario_getLabel: 'test success if myscript',
      scenario_isOutline: false,
      scenario_result: 'failed',
      scenario_scenarioName: 'test success if myscript',
      test_children: undefined,
      test_description: undefined,
      test_error: undefined,
      test_id: '.../use custom runner/django/mysite/features/myscript.feature/test success if myscript',
      test_label: 'test success if myscript',
      test_parent: '.../use custom runner/django/mysite/features/myscript.feature',
      test_uri: '.../use custom runner/django/mysite/features/myscript.feature',
    }),
...
export const getExpectedResultsForMyScriptProfileWaitForJUnitFiles = (): TestResult[] => {
