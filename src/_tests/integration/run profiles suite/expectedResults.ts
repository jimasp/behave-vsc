...
export function getExpectedCounts(): ProjParseCounts {
  ...
  return {
    ...
    stepFileStepsExceptCommentedOut: 8, featureFileStepsExceptCommentedOut: 41, stepMappings: 41
  };
}
...
export const getExpectedResultsForNoTagsSpecified = (): TestResult[] => {
  ...
  const expectedResults: TestResult[] = [
    ...
    new TestResult({
      ...
      test_id: '.../run profiles/features/tags_and_vars.feature/all tags - success - check tags and envvars and userdata',
      test_label: 'all tags - success - check tags and envvars and userdata',
    ...
    new TestResult({
      scenario_featureFileRelativePath: 'features/tags_and_vars.feature',
      scenario_featureName: 'Run Profiles Feature',
      scenario_getLabel: 'untagged - success - check tags and envvars and userdata',
      scenario_isOutline: false,
      scenario_result: 'passed',
      scenario_scenarioName: 'untagged - success - check tags and envvars and userdata',
      test_children: undefined,
      test_description: undefined,
      test_error: undefined,
      test_id: '.../run profiles/features/tags_and_vars.feature/untagged - success - check tags and envvars and userdata',
      test_label: 'untagged - success - check tags and envvars and userdata',
      test_parent: '.../run profiles/features/tags_and_vars.feature',
      test_uri: '.../run profiles/features/tags_and_vars.feature',
    }),
