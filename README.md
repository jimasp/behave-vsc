...
- *How does step type matching working when using Go to Step Definition or Find All Step References?* Step type matching should work as per behave, i.e. Go to Step Definition works like this: "Given" -> @given/@step, "And" -> @given/@then/@step, "When" -> @when/@step, "Then" -> @then/@step, "But" -> @then/@step. Find All Step References does the reverse.
